...
- [x] 2.1.1 - Créer AuthService avec providers multiples
- [x] 2.1.2 - Implémenter gestion session persistante
- [x] 2.1.3 - Gestion refresh tokens automatique
- [x] 2.1.4 - Système offline auth (7 jours cache)
- [x] 2.1.5 - Error handling auth avec messages français
...
- [x] 2.2.1 - Écran Welcome avec branding Thomas
- [x] 2.2.2 - Écran Sign In (Email/Google/Apple)
- [x] 2.2.3 - Écran Sign Up avec validation
- [x] 2.2.4 - Écran Reset Password
- [x] 2.2.5 - Flux onboarding nouveaux utilisateurs (ignoré)
- [x] 2.2.6 - Gestion erreurs avec messages français
...
- [x] 3.1.1 - Créer tables farms, farm_members, farm_invitations
- [x] 3.1.2 - Setup RLS (Row Level Security) pour multi-tenant
- [x] 3.1.3 - Créer fonctions DB pour gestion permissions
- [x] 3.1.4 - Scripts migration + seeds de test
- [x] 3.1.5 - Index optimisation performances
