-- ============================================================================
-- Migration 031: Amélioration extraction quantités agricoles
-- ============================================================================
-- Description: Améliore le prompt pour mieux extraire les quantités pour
--              tous les types d'actions (plantation, semis, pulvérisation, etc.)
--              avec inférence intelligente des unités selon le verbe
-- Date: 2026-01-07
-- ============================================================================
...
DO $$ 
BEGIN 
  RAISE NOTICE '✅ Migration 031 appliquée: Amélioration extraction quantités agricoles';
  RAISE NOTICE '📊 Version thomas_agent_system: 2.8';
  RAISE NOTICE '🌾 Quantités supportées: plantation, semis, pulvérisation, fertilisation, arrosage';
  RAISE NOTICE '🎯 Inférence unités: planté→plants, semé→graines, pulvérisé→L';
  RAISE NOTICE '📦 Nouveaux champs: quantity_nature et quantity_type';
END $$;
